...
class WP_Test_REST_Schema_Initialization extends WP_Test_REST_TestCase {
	...
	public function test_expected_routes_in_schema() {
		...
		// Test that each of the expected core routes exists in the schema.
		foreach( $expected_routes as $route ) {
			$this->assertTrue( isset( $routes[ $route ] ), $route . ' route should exist in the schema.' );
		}
}

	public function test_routes_in_schema_resolve_correctly() {
		...
		$file = './tests/qunit/fixtures/wp-api.js';
